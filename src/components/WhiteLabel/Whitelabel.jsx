...
import secoundPhotoBarber from '../../assets/images/profissional01.jpeg'
import semiPhotos from '../../assets/images/profissional01.jpeg'
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
        <S.InfosProfissional>
          ...
          <S.MiddleContent>
            <S.PhotoAndPlace>
              <S.ProfissionalPhoto>
                <img src={secoundPhotoBarber} alt="" className='animate__animated animate__fadeIn animate__delay-3s'/>
              </S.ProfissionalPhoto>
              <S.PhotoPlace>
